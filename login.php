...
<a href="lost.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="忘记密码了？"><i class="fa fa-exclamation-circle">找回密码</i></a>
<a href="register.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="注册"><i class="fa fa-plus">注册</i></a>
</div>
<h2>会员登录<img id="loginimage" src="img/jquery.easytree/loading.gif" style="display:none"/></h2>
</div>
...
<span></span>
</label>同意<a href="<?php echo htmlspecialchars($tos); ?>">服务条款</a>
</div>
<div class="col-xs-4 text-right">
<button type="button" onclick="login()" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-check"></i>立即登录</button>
</div>
</div>
</div>
</div>
<footer class="text-muted text-center animation-pullUp">
<small><span id="year-copy"></span> &copy; <a href="<?php echo htmlspecialchars($siteurl); ?>" target="_blank"><?php echo htmlspecialchars($sitename); ?></a><br/></small>
</footer>
</div>
