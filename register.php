...
<head>
        ...
        <title><?php echo htmlspecialchars($sitename); ?> - 注册</title>
...
<i class="fa fa-plus"></i> <strong>注册会员</strong>
</h1>
<div id="registerdiv" style="display:inline"></div>
<div class="block animation-fadeInQuickInv">
<div class="block-title">
<div class="block-options pull-right">
<a href="login.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="登录"><i class="fa fa-user"></i></a>
</div>
<h2>注册<img id="registerimage" src="img/jquery.easytree/loading.gif" style="display:none"/></h2>
</div>
...
<div class="form-group">
<div class="col-xs-12">
<input type="password" id="rpassword" class="form-control" placeholder="确认密码">
</div>
</div>
<div class="form-group">
<div class="col-xs-12">
<input type="text" id="scode" class="form-control" placeholder="秘密代码，4位(找回密码用)">
</div>
</div>
<div class="form-group">
<div class="col-xs-12">
...
<div class="col-xs-6">
<label class="csscheckbox csscheckbox-primary" data-toggle="tooltip" title="同意条款">
<input type="checkbox" name="keep" >
<span></span>
</label>
<a href="<?php echo htmlspecialchars($tos); ?>" target="_blank">我同意服务条款</a></a>
</div>
<div class="col-xs-4 text-right">
<button class="btn btn-effect-ripple btn-default" type="button" onclick="register()"><i class="fa fa-plus"></i>注册</button>
</div>
</div>
</div>
</div>
<footer class="text-muted text-center animation-pullUp">
<small><span id="year-copy"></span> &copy; <a href="<?php echo htmlspecialchars($siteurl); ?>" target="_blank"><?php echo htmlspecialchars($sitename); ?></a><br/><script src="https://s95.cnzz.com/z_stat.php?id=1261233025&web_id=1261233025" language="JavaScript"></script></small>
</footer>
</div>
