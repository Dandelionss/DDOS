...
<a href="lost.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="Íü¼ÇÃÜÂëÁË£¿"><i class="fa fa-exclamation-circle"></i></a>
<a href="register.php" class="btn btn-effect-ripple btn-primary" data-toggle="tooltip" data-placement="left" title="×¢²á"><i class="fa fa-plus"></i></a>
</div>
<h2>Login <img id="loginimage" src="img/jquery.easytree/loading.gif" style="display:none"/></h2>
</div>
...
Í¬Òâ <a href="<?php echo htmlspecialchars($tos); ?>">TOS</a>
</div>
<div class="col-xs-4 text-right">
<button type="button" onclick="login()" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-check"></i> µÇÂ¼</button>
</div>
</div>
</div>
</div>
