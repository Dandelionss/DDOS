                    ...
                    <div id="page-content">
						...
						<div id="div" style="display:inline"></div>
							...
							<div class="widget">
								...
								<span class="pull-right text-muted">压力测试</span>
								<i class="fa fa-bomb"></i> <b>面板<img id="image" src="img/jquery.easytree/loading.gif" style="display:none"/></b>
								</div>
								...
								<div class="widget-content">
									...
									<span class="help-block">数字真实IP</span>
									</div>
									</div>
									<div class="form-group">
									...
									<span class="help-block">默认: 80</span>
									</div>
									</div>
									<div class="form-group">
									...
									<span class="help-block">您的最大时间
<?php echo $rowxd['mbt']; ?>秒</span>
									</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
									<div class="col-md-12">
									<button id="launch" onclick="start()" class="btn btn-effect-ripple btn-primary btn-block">发送攻击(轮流)</button>
									</div>
									</div>
									</div>
									</div>
						...
						<div class="col-xs-8">
							...
							<div class="widget">
								<div class="widget-content widget-content-mini themed-background-dark text-light-op">
								<span class="pull-right text-muted">压力测试</span>
								<i class="fa fa-send"></i> <span <?php if ($user -> isAdmin($odb)) {echo 'class="tip" onclick="adminattacks()" title="Click for admin mode" style="cursor:pointer"';} ?>><strong>管理</strong>攻击</span> <img id="attacksimage" src="img/jquery.easytree/loading.gif" style="display:none"/>
								</div>
